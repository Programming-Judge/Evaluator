...
do
    ...
    timeout $4 python3 $3/uploads/$5 < $3/tests/$1-input/input/input-$a.txt &> $1-code-output.txt 
    ...
    diff --strip-trailing-cr $1-code-output.txt $3/tests/$1-output/output/output-$a.txt > $1-diff-messages.txt
    if [ $? != 0 ]; then
